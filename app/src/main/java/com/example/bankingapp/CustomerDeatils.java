...
public class CustomerDeatils extends AppCompatActivity {
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(senderID.equals("")) {
                    Intent CustomerDetails = new Intent(getApplicationContext(), CustomerProfile.class);
                    ...
                    if(senderID.equals(receiverID)){
                        Toast.makeText(CustomerDeatils.this, "Sender and receiver can not be same", Toast.LENGTH_SHORT).show();
                    }
                    else{
